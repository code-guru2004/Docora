...
import { Filter, Grid, List, Search, SlidersHorizontal, ArrowUpDown, RefreshCw, BookmarkCheck } from 'lucide-react';
      ...
      <div className="mt-6 flex flex-col gap-4 md:flex-row md:items-center">
        ...
        {(selectedCategory !== 'all' || selectedType !== 'all' || selectedSort !== 'latest' || searchQuery || selectedTag) && (
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-full border border-gray-200 bg-gray-50/50 px-4 py-2 text-xs font-bold text-gray-600 hover:bg-gray-100"
          >
            ...
            <div className="flex flex-col gap-1.5">
              {[
                ...
                <button
                  ...
                  className={`flex w-full items-center justify-between rounded-xl px-3 py-2.5 text-left text-xs font-semibold border transition-all ${
